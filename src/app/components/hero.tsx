...
export default function Hero(){
  return(
    <div className="bg-gradient-to-r from-sky-300 to-red-300 w-full h-96 p-12 flex flex-row mb-8">
      ...
      <div className="flex flex-col justify-center align-middle ml-24 w-96">
        <Image
          src={Codeagon}
