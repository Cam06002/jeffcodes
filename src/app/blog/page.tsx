  ...
  return (
    <div className="flex flex-col m-8 w-full align-middle font-Orbitron">
      <div className="mb-6 bg-gradient-to-r from-sky-300 to-red-300 w-full h-fit px-8 py-8 md:px-12 flex flex-col align-middle justify-center text-gray-900/50">
        <h1 className="text-3xl font-bold align-middle justify-center flex">
          Jeff Writes
        </h1>
      ...
      {result.posts.map((post) => (
        <div
          className="flex flex-row align-middle justify-between mb-2 border-sky-300 border-2 rounded p-2 hover:bg-slate-900"
          key={post.id}
        >
          <Link href={`/blog/${post.slug}`}>
            <div className="flex flex-row">
              ...
              <div className="flex flex-col w-3/4">
                ...
                <p className="italic text-white mb-4 text-sm">
